      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        <header className="h-16 border-b border-white/5 bg-card/50 flex items-center justify-between px-6">
          <div className="flex items-center gap-3">
            ...
            <h1 className="font-heading text-xl font-bold">AI Models</h1>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <CardContent className="p-4">
                  <div className="flex items-center gap-3">
                    <div className={`w-10 h-10 rounded-lg flex items-center justify-center ${
                      status?.ollama_running ? 'bg-green-500/10' : 'bg-red-500/10'
                    }`}>
              ...
              <Card className="bg-card border-white/5">
                <CardContent className="p-4">
                  <div className="flex items-center gap-3">
                    <div className={`w-10 h-10 rounded-lg flex items-center justify-center ${
                      status?.bytez_configured ? 'bg-green-500/10' : 'bg-yellow-500/10'
                    }`}>
                      <Cloud className={`w-5 h-5 ${
                        status?.bytez_configured ? 'text-green-400' : 'text-yellow-400'
                      }`} />
                    </div>
                    <div>
